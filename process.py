...
.viewer-image-pane img.rot90{{transform:rotate(90deg);max-width:calc(100vh - 160px);margin-top:calc((100vw - 360px) / 2 - 20px)}}
.viewer-image-pane img.rot180{{transform:rotate(180deg);margin-top:24px}}
.viewer-image-pane img.rot270{{transform:rotate(270deg);max-width:calc(100vh - 160px);margin-top:calc((100vw - 360px) / 2 - 20px)}}
